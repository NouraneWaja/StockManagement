...
describe('Categorie e2e test', () => {
  ...
  describe('new Categorie page', () => {
    ...
    it('should create an instance of Categorie', () => {
      cy.get(`[data-cy="nom"]`).type('lorsque');
      cy.get(`[data-cy="nom"]`).should('have.value', 'lorsque');

      cy.get(`[data-cy="description"]`).type('Blues');
      cy.get(`[data-cy="description"]`).should('have.value', 'Blues');
