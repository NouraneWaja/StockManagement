...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        ...
        if (
            ex instanceof com.mycompany.myapp.service.CodebarresAlreadyUsedException
        ) return (ProblemDetailWithCause) new CodebarresAlreadyUsedException().getBody();
        if (
            ex instanceof com.mycompany.myapp.service.CategoryAlreadyUsedException
        ) return (ProblemDetailWithCause) new CategoryAlreadyUsedException().getBody();
