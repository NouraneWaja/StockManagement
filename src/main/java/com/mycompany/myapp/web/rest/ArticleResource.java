...
public class ArticleResource {
    ...
    //calculer la quantite totale des articles
    @GetMapping("/articles/count")
    public Long getArticleCount() {
        return articleRepository.getArticleCount(); // le nombre d'article
    }
    ...
    public ResponseEntity<Article> partialUpdateArticle(
        ...
        Optional<Article> result = articleRepository
            ...
            .map(existingArticle -> {
                ...
                if (article.getCodebarres() != null) {
                    existingArticle.setCodebarres(article.getCodebarres());
                }
